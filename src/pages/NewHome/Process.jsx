...
export default function GrowthSection({ setAllowNext, setAllowPrev }) {
  const data = [
    ...
    {
      type: 'service',
      name: 'TNR Constructions',
      image: '/img/Img9.png',
      description: 'Residential community solutions',
    },
    {
      type: 'service',
      name: 'JIVI Towers',
      image: '/img/Img9.png',
      description: 'Commercial facility services',
    },
    {
      type: 'service',
      name: 'Tranquil',
    ...
    },
    {
      ...
      name: 'Skilltyro',
      image: '/img/Img7.png',
      description: 'Industrial operations management',
    },
    {
      type: 'service',
      name: 'DocTutorials',
      image: '/img/Img11.png',
      description: 'Corporate workspace solutions',
    },
  ];
  ...
  return (
    ...
    >
      ...
      {current.type === 'title' && (
        ...
        >
          <Typography sx={{ fontSize: { xs: 32, md: 70 }, fontWeight: 900, lineHeight: 1.4 }}>
            {current.name}
          </Typography>
        </motion.div>
      )}

      ...
      >
        <Toolbar sx={{
          ...
          >
            <Typography sx={{
              fontWeight: 700,
              fontSize: { xs: 10, sm: 12, md: 30 },
              letterSpacing: { xs: 0.5, md: 1 },
            }}>
              GET QUOTE
            </Typography>
            <NorthEastIcon sx={{ fontSize: { xs: 14, sm: 18, md: 28 } }} />
          </Box>
        </Toolbar>
      </AppBar>
        ...
        {open && (
          ...
          >
            ...
            >
              ...
              >
                <Typography sx={{ fontSize: { xs: 10, sm: 12, md: 30 }, fontWeight: 700 }}>GET QUOTE</Typography>
                <NorthEastIcon sx={{ fontSize: { xs: 14, sm: 18, md: 24 } }} />
              </Box>
            </motion.div>
